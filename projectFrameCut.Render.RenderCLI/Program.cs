...
namespace projectFrameCut.Render.RenderCLI
{
    internal class Program
    {
        ...
        {
            //VideoClip a = new VideoClip("1", "test", 0, 100, 30, null, "test.mp4");
            //VideoClip b = new VideoClip("2", "test1", 0, 100, 30, null, "test1.mp4")
            //{
            //    LayerIndex = 1,
            //    MixtureMode = RenderMode.Overlay,
            //    Effects = new Effects[]
            //    {
            //        new Effects(EffectType.RemoveColor,["1","2"])
            //    }
            //};


            //PhotoClip c = new PhotoClip("3", "photo1", 0, 100, 30, null, "test.png");

            //string aJson = JsonSerializer.Serialize(a);
            //string bJson = JsonSerializer.Serialize(b);
            //string cJson = JsonSerializer.Serialize(c);

            //DraftStructure d = new DraftStructure
            //{
            //    Clips = [aJson, bJson, cJson],
            //    ClipsType = [ClipMode.VideoClip, ClipMode.VideoClip, ClipMode.PhotoClip]
            //}
