...
namespace projectFrameCut.ApplicationPluginBase.Effect
{
    public class ZoominEffectBundle : IEffectBundle
    {
        ...
        {
            return [new Render.Effect.ZoomInContinuousEffectFactory().Build(EffectImplementType.NotSpecified, Parameters)];
        }
        ...
        {
            Parameters[args.Id] = int.TryParse(args.Value as string, out var i) ? i : 0;
            return Parameters;
        }
