...
namespace projectFrameCut
{
    public static class MauiProgram
    {
        ...
        public static MauiApp CreateMauiApp()
        {
            ...
            try
            {
                loggingDir = System.IO.Path.Combine(Environment.CurrentDirectory, "logging");
                var userHome = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile);
                DataPath = Path.Combine(userHome, "projectFrameCut");
                BasicDataPath = Path.Combine(userHome, "projectFrameCut", "AppData");
                loggingDir = Path.Combine(userHome, "projectFrameCut", "AppData", "Logs");
                try
                {
                ...
                catch (Exception ex)
                {
                    ...
                    BasicDataPath = Environment.CurrentDirectory;
                    loggingDir = System.IO.Path.Combine(Environment.CurrentDirectory, "logging");
                }
            ...
            Log($"projectFrameCut.Avalonia - v{Assembly.GetExecutingAssembly().GetName().Version} \r\n" +
                $"                  on {RuntimeInformation.RuntimeIdentifier} in cpu arch {RuntimeInformation.ProcessArchitecture},\r\n" +
...
#if !IOS && !MACCATALYST && !ANDROID && !WINDOWS && !BROWSER
                       .UseAvaloniaApp()
#elif BROWSER
                       .UseAvaloniaApp(true)
#else
...
#pragma warning restore CS0618
...
#elif ANDROID
                        nativeLibDirOverride = Path.Combine(Environment.CurrentDirectory, "ffmpeg_plugin_libs");
#endif
                    }
                }
                catch { }
                FFmpegRoot = nativeLibDirOverride ?? AppContext.BaseDirectory;
        ...
        internal partial class AvaloniaApp : Avalonia.Controls.Maui.Platform.MauiAvaloniaApplication //it works anyway huh
        {
            ...
            protected override MauiApp CreateMauiApp() => global::projectFrameCut.MauiProgram.CreateMauiApp();
        }
#endif
